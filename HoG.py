# -*- coding: utf-8 -*-
"""
Created on Sun Apr 26 18:24:25 2020

@author: chenlin
Histogram of Gradients for a patch

This is adapted from github page 
...
class HOGLayer(nn.Module):
    ...
    def forward(self, x):
        with torch.no_grad():
            ...
            phase = phase%(2*math.pi) #convert to (0,2pi)
            self.phase = phase
...
#    path = './logs/new/test.bmp'
    path = './logs/new/out_patches_a_crop_29.jpg'
    ...
    hog = HOGLayer(nbins=24, pool=32, max_angle=2*math.pi)
    if cuda:
        hog = hog.cuda()
