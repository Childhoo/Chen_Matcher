# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 16:53:22 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 25 19:53:34 2020


@author: chenlin
extract all features using join trained descriptor+aff+ori module
"""
...
weightd_fname = '../../logs/AFFNet_OriNetFast_Joint_UsingHardNetPS_lr00001_10M_20ep_aswap_03022020_PosDistLoss_Lowertilt_Fullaffinesimu_AffNetFast_6Brown_HardNetPS_1e-05_10000000_PosDist/checkpoint_aff_9.pth'
...
weightd_fname_orinet = '../../logs/AFFNet_OriNetFast_Joint_UsingHardNetPS_lr00001_10M_20ep_aswap_03022020_PosDistLoss_Lowertilt_Fullaffinesimu_AffNetFast_6Brown_HardNetPS_1e-05_10000000_PosDist/checkpoint_ori_9.pth'
...
descriptor = HardNetPS()
#model_weights = '../../logs/checkpoint_9.pth'
model_weights = '../../pretrained/3rd_party/HardNetPS/HardNetPS.pth'
#model_weights = '../../logs/checkpoint_9.pth'
hncheckpoint = torch.load(model_weights)
descriptor.load_state_dict(hncheckpoint)
descriptor.eval()
